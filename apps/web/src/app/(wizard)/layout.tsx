  ...
  return (
    <div className="flex bg-slate-50 dark:bg-slate-950 h-screen w-screen overflow-hidden text-slate-900 dark:text-slate-50">
      <div className="absolute top-6 left-6 z-10 flex items-center gap-2">
        {hasCompanies ? (
          <Link href="/empresas" className="flex items-center gap-2 hover:opacity-80 transition-opacity" title="Voltar ao início">
            <VertexHubLogo className="size-8 text-primary" />
            <span className="font-bold text-lg tracking-tight">VertexHub</span>
          </Link>
        ) : (
          <>
            <VertexHubLogo className="size-8 text-primary" />
