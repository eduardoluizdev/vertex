...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div
      className={`not-last:border-b rounded-xl border border-white/5 bg-white/[0.02] px-5 transition-colors ${isOpen ? "border-white/10 bg-white/[0.04]" : ""}`}
    >
      <button
      ...
      <header className="fixed top-0 z-50 w-full transition-all duration-300 bg-[#0A0A0A]/80 backdrop-blur-md border-b border-white/5">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6">
          ...
          <nav className="hidden items-center gap-1 md:flex">
            <a
              href="#o-que-e"
              className="rounded-md px-3 py-1.5 text-xs text-neutral-400 transition-colors hover:text-white"
            >
              O que é
            </a>
            <a
          ...
          <div className="flex gap-2">
            <Link href="/login">
              <Button
                size="sm"
                variant="ghost"
                className="h-8 rounded-lg px-4 text-xs font-semibold text-neutral-300 hover:text-white hover:bg-white/10 hidden sm:inline-flex"
              >
                Entrar
              </Button>
            </Link>
            <Link href="/register">
              <Button
                size="sm"
                className="h-8 rounded-lg px-4 text-xs font-semibold bg-vibe-primary text-black hover:bg-vibe-primary/90"
              >
                Criar Conta
              </Button>
            </Link>
      ...
      <main>
        ...
        <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden pt-14">
          ...
          <div className="relative mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 z-10">
            ...
            <h1 className="text-balance text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl md:text-6xl">
              ...
              <span className="bg-gradient-to-r from-vibe-primary to-amber-300 bg-clip-text text-transparent">
                Agências e Devs
              </span>
            </h1>
            <p className="mx-auto mt-6 max-w-xl text-balance text-base leading-relaxed text-neutral-400 sm:text-lg">
              VertexHub centraliza empresas, clientes, integrações e propostas
              em um único lugar. Pare de usar planilhas e comece a escalar.
            </p>
        ...
        <section id="o-que-e" className="relative py-24">
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            <div>
              <p className="text-xs font-medium uppercase tracking-wider text-vibe-primary">
                Por que existimos
              </p>
              <h2 className="mt-2 text-2xl font-bold tracking-tight text-white sm:text-3xl">
                Software focado na sua operação.
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-neutral-400 sm:text-base">
                Esqueça a dor de gerenciar clientes pelo WhatsApp misturado ao
                Trello. O VertexHub organiza sua operação B2B com clareza.
              </p>
            </div>
            <div className="mt-10 grid gap-4">
              <div className="flex items-start gap-4 rounded-xl border border-white/5 bg-white/[0.02] p-5 transition-colors hover:border-white/10 hover:bg-white/[0.04]">
                ...
                <span className="text-sm text-neutral-300 leading-relaxed">
                  ...
                  Navegue entre múltiplos projetos e mantenha clientes, serviços
                  e dashboards completamente separados.
                </span>
              </div>
              <div className="flex items-start gap-4 rounded-xl border border-white/5 bg-white/[0.02] p-5 transition-colors hover:border-white/10 hover:bg-white/[0.04]">
                <span className="mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full bg-vibe-primary/15 text-vibe-primary">
                ...
                <span className="text-sm text-neutral-300 leading-relaxed">
                  <strong className="text-white">
                    Propostas integradas ao Servidor:
                  </strong>{" "}
                  Gere domínios no Easypanel e publique propostas linkadas em
                  questão de segundos.
                </span>
              </div>
              <div className="flex items-start gap-4 rounded-xl border border-white/5 bg-white/[0.02] p-5 transition-colors hover:border-white/10 hover:bg-white/[0.04]">
                ...
                <span className="text-sm text-neutral-300 leading-relaxed">
                  <strong className="text-white">
                    Motor de Integrações Nativas:
                  </strong>{" "}
                  Plugue sua Evolution API (WhatsApp) e Resend (Email) para
          ...
          <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-neutral-400 sm:text-base">
                Módulos precisos pensados em desenvolvedores e agências de
                software.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col h-full rounded-xl border border-white/5 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(245,158,11,0.05)] group">
                ...
                <p className="text-xs leading-relaxed text-neutral-400">
                  Atenda vários projetos com a mesma conta, troque de empresa e
                  isole configs de webhook ou tokens.
                </p>
              </div>
              ...
              <div className="flex flex-col h-full rounded-xl border border-white/5 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(245,158,11,0.05)] group">
                ...
                <p className="text-xs leading-relaxed text-neutral-400">
                  Lance um domínio pelo seu próprio painel web via API Easypanel
                  e envie um link ativo da proposta.
                </p>
              </div>
              ...
              <div className="flex flex-col h-full rounded-xl border border-white/5 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(245,158,11,0.05)] group">
                ...
                <h3 className="text-sm font-semibold text-white mb-2">
                  Engenharia de Notificações
                </h3>
                <p className="text-xs leading-relaxed text-neutral-400">
                  Módulos oficiais para comunicação via mensageiros. Você foca
                  no Lead, nós mantemos a infraestrutura conectada.
                </p>
              </div>
              ...
              <div className="flex flex-col h-full rounded-xl border border-white/5 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(245,158,11,0.05)] group">
                ...
                <p className="text-xs leading-relaxed text-neutral-400">
                  Gráficos vitais baseados nos seus serviços fechados ou em
                  funil de vendas abertos em cada empresa ativa.
                </p>
              </div>
              ...
              <div className="flex flex-col h-full rounded-xl border border-white/5 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(245,158,11,0.05)] group">
                ...
                <p className="text-xs leading-relaxed text-neutral-400">
                  Entenda de onde vieram seus Leads mais lucrativos e saiba
                  precisamente como o negócio transaciona fluxo.
                </p>
              </div>
              ...
              <div className="flex flex-col h-full rounded-xl border border-white/5 bg-white/[0.02] p-6 transition-all duration-300 hover:border-white/10 hover:bg-white/[0.04] hover:shadow-[0_0_30px_rgba(245,158,11,0.05)] group">
                ...
                <h3 className="text-sm font-semibold text-white mb-2">
                  Disparos Estratégicos
                </h3>
                <p className="text-xs leading-relaxed text-neutral-400">
                  Monte réguas de mensagens de WhatsApp direto pelo portal para
                  aquecer leads B2B e alavancar conversões.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="rounded-xl border border-white/5 bg-white/[0.02] p-6 sm:p-8">
                ...
                <ul className="mt-6 grid gap-4">
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    ...
                    Você possui Agência (Web/Design/Tráfego) e múltiplos
                    clientes pontuais
                  </li>
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    <Check className="mt-0.5 size-4 shrink-0 text-emerald-500/70" />
                  ...
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    <Check className="mt-0.5 size-4 shrink-0 text-emerald-500/70" />
                    Misturava cobrança e histórico operacional no WhatsApp
                    pessoal
                  </li>
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    <Check className="mt-0.5 size-4 shrink-0 text-emerald-500/70" />
                    Você prefere softwares diretos, limpos e otimizados fáceis
                    de ler
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl border border-white/5 bg-white/[0.02] p-6 sm:p-8">
                ...
                <ul className="mt-6 grid gap-4">
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    ...
                    Sua empresa é varejo puramente físico (ex: padarias,
                    farmácias)
                  </li>
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    <X className="mt-0.5 size-4 shrink-0 text-red-500/70" />
                    Você precisa de recursos de integração fiscal e emissão de
                    NFe contábil bruta
                  </li>
                  <li className="flex items-start gap-3 text-sm text-neutral-300">
                    <X className="mt-0.5 size-4 shrink-0 text-red-500/70" />
                    Sua operação foca unicamente em SPAM B2C de atacado com
                    milhões de contatos
                  </li>
                </ul>
              </div>
            ...
            <div className="mt-12 rounded-xl border border-white/5 bg-white/[0.02] p-6 sm:p-10">
              <div className="flex flex-col md:flex-row gap-10 items-center">
                <div className="flex-1 space-y-4 text-neutral-300 text-sm leading-relaxed">
                  <p>
                    A plataforma nasceu de uma necessidade íntima: gerir
                    agências de serviços digitais e desenvolvimento de software
                    não precisava ser um remendo de planilhas.
                  </p>
                  <p>
                    Nesta <strong>Fase BETA Pública</strong>, estamos modelando
                    a experiência focada em você. Contribuindo com seu uso ativo
                    e sugestões de funcionalidade, isentamos seu custo de
                    servidor durante todo o período primário.
                  </p>
                  <p>
                    Sem "pegadinhas", sem travas. Tudo (CRM, Propostas,
                    Integrações e Campanhas) liberado para o seu workflow
                    brilhar de forma consistente.
                  </p>
                </div>
        ...
        <section className="relative py-32 border-t border-white/5 bg-white/[0.01]">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              Pronto para a nova gestão?
            </h2>
            <p className="mx-auto mt-4 max-w-md text-sm text-neutral-400 sm:text-base">
              Mudo o paradigma da sua agência hoje, do zero ao Pro sem
              burocracia.
            </p>
            <Link href="/register">
        ...
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-10 px-4 text-sm lg:flex-row lg:px-6">
          <div className="flex flex-col items-center gap-5 lg:items-start text-center lg:text-left">
            ...
            <span className="max-w-xs">
              SaaS de gestão empresarial inteligente focada para devs freelances
              e agências digitais.
            </span>
          ...
          <div className="flex flex-col gap-3 lg:ml-auto items-center lg:items-start">
            <span className="text-neutral-500 uppercase text-xs font-semibold tracking-wider mb-1">
              Acesso
            </span>
